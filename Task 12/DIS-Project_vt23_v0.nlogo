...
to go
  ...
  ; Trying to implement a Hybrid-Agent architecture with a reactive part running the intentions on
...
"" ""
PENS
"Cops" 1.0 0 -14070903 true "" "plot count turtles with [breed = cops]"
"Citizens" 1.0 0 -6459832 true "" "plot count turtles with [breed = citizens AND activist? = false]"
